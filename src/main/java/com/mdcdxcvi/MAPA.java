...
public class MAPA {
	...
	public static void Combate(String Direcao, String ERRO, float Vida, int Comida, int Fome, float Vida_Monstro,
			String L_MAPA, String MAO_D, String MAO_E, int u, int v) {
		Random gerador = new Random();
		BufferedReader entrada;
		entrada = new BufferedReader(new InputStreamReader(System.in));
		int Vantagem_MONS = 0;
